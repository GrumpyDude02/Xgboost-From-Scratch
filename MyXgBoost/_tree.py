...
class _BaseTree:
    ...
    class Node:
        def __init__(self, left=None, right=None, value=None, split=None, feature=None, score=None, obs_num=None) -> None:
            self.split = split
            self.value = value
    ...
    def _build_tree(self, X, y, depth):
        ...
        return _BaseTree.Node(left, right, split=split, feature=feature, score=score, obs_num=len(x))
